  ...
  return (
    ...
    <div className='w-full flex justify-between items-center font-semiblod'>
        ...
        <div className='flex items-center gap-4'>
            <p className='bg-white text-black text-[15px] px-4 py-1 font-bold rounded-2xl hidden md:block cursor-pointer'>Explore Premium</p>
            <p className='bg-black py-1 px-4 rounded-2xl text-[15px] font-bold cursor-pointer'>Install App</p>
            <p className='bg-purple-500 text-black w-7 h-7 rounded-full flex items-center justify-center cursor-pointer'>M</p>
        </div>
    </div>
    <div className='flex items-center gap-2 mt-4'>
        <p className='bg-white text-black font-bold px-4 py-1 rounded-2xl'>All</p>
